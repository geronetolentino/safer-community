...
class AccountController extends Controller
{
    public function index()
    {
        ...
        return view('resident.account.index')->with($data);
    }
    ...
    public function edit()
    {
        ...
        return view('resident.account.edit')->with($data);
    }
    ...
    public function enrollEmployee($eep, $hash)
    {
        
        $data = [
            'pageName' => 'Employee Enrollment Page',
            'navName' => 'Dashboard',
        ];
