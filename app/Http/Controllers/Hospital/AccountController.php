...
class AccountController extends Controller
{
    ...
    public function edit()
    {
        $data = [
            ...
            'navName' => 'My Profile',
            'barangays' => AddrBarangay::select('id','barangay','addr_municipality_id')->orderByRaw('barangay ASC')->get(),
            'municipalities' => AddrMunicipality::select('id','municipality')->orderBy('municipality', 'asc')->get(),
            'provincies' => AddrProvince::get(),
        ];
