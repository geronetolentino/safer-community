                                            ...
                                            <div class="col-xl-9 col-lg-12 col-md-8 mt-md-0 mt-4">
                                                <div class="form">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <label for="est_code">Establistment Code</label>
                                                                <input type="text" class="form-control mb-4" id="est_code" value="{{ Auth::user()->establishment->est_code }}" readonly="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    FilePond.setOptions({
        server: {
            process:(fieldName, file, metadata, load, error, progress, abort, transfer, options) => {
                ...
                request.open('POST', '{{ route('es.account.photo') }}');
