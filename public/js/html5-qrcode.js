            ...
            [
                                ...
                                if (g._shouldScan) {
                                    if (g._localMediaStream) {
                                        ...
                                        g._context.drawImage(g._videoElement, k, l, i, j, 0, 0, g._qrRegion.width, g._qrRegion.height),
                                            n() || !0 === h.disableFlip || (f._context.translate(f._context.canvas.width, 0), f._context.scale(-1, 1), n());
                                    }
                ...
                },
                {
                    ...
                    value: function (b, c, d) {
                        ...
                        if (0 != d.x || 0 != d.y) {
                            var f = {};
                            (f[a.SHADED_LEFT] = this._createShadedElement(c, d, a.SHADED_LEFT)),
                                (f[a.SHADED_RIGHT] = this._createShadedElement(c, d, a.SHADED_RIGHT)),
                                (f[a.SHADED_TOP] = this._createShadedElement(c, d, a.SHADED_TOP)),
                                (f[a.SHADED_BOTTOM] = this._createShadedElement(c, d, a.SHADED_BOTTOM)),
        ...
        _createClass(a, [
            ...
            },
            {
                ...
                value: function () {
                    ...
                    g.setAttribute("class","btn btn-primary");
            ...
            },
            {
                ...
                value: function (b) {
                    ...
                    f.setAttribute("class", "custom-select w-40");
                    ...
                    n.setAttribute("class","btn btn-primary");
                    (n.innerHTML = "Start Scanning"), m.appendChild(n);
                    var o = document.createElement("button");

                    o.setAttribute("class","btn btn-danger");
...
_defineProperty(Html5QrcodeScanner, "SCAN_TYPE_CAMERA", "SCAN_TYPE_CAMERA"),
    ...
    _defineProperty(Html5QrcodeScanner, "ASSET_FILE_SCAN", "../../public/js/file-scan.gif"),
    _defineProperty(Html5QrcodeScanner, "ASSET_CAMERA_SCAN", "../../public/js/camera-scan.gif");
